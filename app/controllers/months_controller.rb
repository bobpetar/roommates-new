class MonthsController < ApplicationController
  ...
  # GET /months.json
  def index
    @months = Month.order('created_at DESC')
  end
  ...
  def create
    ...
    respond_to do |format|
      if @month.save
        format.html { redirect_to root_url, notice: 'Month was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @month.update(month_params)
        format.html { redirect_to root_url, notice: 'Month was successfully updated.' }
